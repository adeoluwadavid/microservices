...
dataSource
    ...
    amqp.connect("amqps://udmuktmn:gK0QvYKZ8CE9HrdkBmU3-Elfxfwmz4oY@sparrow.rmq.cloudamqp.com/udmuktmn", function (err, connection) {
        if (err)
            throw err;
        connection.createChannel(function (err, channel) {
            ...
            app.get("/api/products/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            productId = req && req.params && req.params.id;
    ...
    .catch(function (error) { return console.log("DB Error: ", error); });
